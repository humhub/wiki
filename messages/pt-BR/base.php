...
return [
  ...
  'Administer pages' => 'Administrar páginas',
  'Advanced settings' => 'Configurações avançadas',
  'Allows the user to administer pages (rename, delete, protect, make homepage)' => 'Permite ao usuário administrar páginas (renomear, excluir, proteger, definir como página inicial).',
  'Allows the user to create new pages' => 'Permite ao usuário criar novas páginas.',
  'Allows the user to edit or revert pages' => 'Permite ao usuário editar ou reverter páginas.',
  'Allows the user to view the history of wiki pages' => 'Permite ao usuário visualizar o histórico das páginas wiki.',
  'Allows the user to view wiki pages' => 'Permite ao usuário visualizar páginas wiki.',
  ...
  'Wiki page content ID' => 'ID do conteúdo da página Wiki',

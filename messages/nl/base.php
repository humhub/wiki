...
return [
  ...
  'Administer pages' => 'Beheer pagina\'s',
  'Advanced settings' => 'Geavanceerde instellingen',
  'Allows the user to administer pages (rename, delete, protect, make homepage)' => 'Sta de gebruiker toe pagina\'s te beheren (hernoemen, verwijderen, beveiligen, als startpagina instellen).',
  'Allows the user to create new pages' => 'Sta de gebruiker toe nieuwe pagina\'s aan te maken.',
  'Allows the user to edit or revert pages' => 'Sta de gebruiker toe pagina\'s te bewerken of terug te zetten naar een eerdere versie.',
  'Allows the user to view the history of wiki pages' => 'Sta de gebruiker toe de geschiedenis van wiki-pagina\'s te bekijken.',
  ...
  '{displayName} edited the Wiki page "{contentTitle}".' => '{displayName} heeft de Wiki-pagina "{contentTitle}" bewerkt.',
];

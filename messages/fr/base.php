...
return [
  ...
  'Administer pages' => 'Administrer les pages',
  'Advanced settings' => 'Paramètres avancés',
  'Allows the user to administer pages (rename, delete, protect, make homepage)' => 'Authoriser l\'utilisateur à administrer les pages (renommer, supprimer, protéger, définir comme page d\'accueil)',
  'Allows the user to create new pages' => 'Permet à l\'utilisateur de créer de nouvelles pages.',
  'Allows the user to edit or revert pages' => 'Permet à l\'utilisateur de modifier ou de rétablir des pages.',
  'Allows the user to view the history of wiki pages' => 'Permet à l\'utilisateur de consulter l\'historique des pages wiki.',
  ...
  '{displayName} edited the Wiki page "{contentTitle}".' => '{displayName} a édité la page Wiki "{contentTitle}".',
];

...
return [
  ...
  'Administer pages' => 'Seiten verwalten',
  'Advanced settings' => 'Erweiterte Einstellungen',
  'Allows the user to administer pages (rename, delete, protect, make homepage)' => 'Erlaubt Benutzern die Verwaltung von Seiten (Umbenennen, Löschen, Schützen, als Startseite festlegen)',
  'Allows the user to create new pages' => 'Erlaubt dem Benutzer das Erstellen neuer Seiten',
  'Allows the user to edit or revert pages' => 'Erlaubt dem Benutzer das Bearbeiten oder Zurücksetzen von Seiten',
  'Allows the user to view the history of wiki pages' => 'Erlaubt es dem Benutzer, den Verlauf von Wiki-Seiten einzusehen',
  'Allows the user to view wiki pages' => 'Ermöglicht dem Benutzer das Einsehen von Wiki-Seiten',
  ...
  'View History' => 'Verlauf einsehen',
  'View pages' => 'Seiten einsehen',
  'Whenever someone edits a wiki page.' => 'Wenn jemand eine Wiki Seite bearbeitet.',
  'Wiki' => 'Wiki',
  'Wiki page' => 'Wiki Seite',
  'Wiki page content ID' => 'Wiki Seite Inhaltskennung',

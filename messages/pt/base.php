...
return array (
  ...
  '<strong>Page</strong> history' => '<strong>História</strong> da página',
  ...
  'Delete' => 'Apagar',
  'Disable edit access for non wiki administrators?' => 'Permitir a edição da wiki por pessoas não administradoras de wikis?',
  ...
  'Index' => 'Índice',
  'Invalid category!' => 'Categoria não válida!',
  'Invalid character in page title!' => 'Caracter não válido no título pretendido!',
  'Is Public' => 'Esta página é pública',
  'Is category' => 'Esta página é uma categoria =P',
